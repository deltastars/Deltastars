...
load_dotenv(dotenv_path=Path(file).resolve().parent.parent.parent / 'secrets.env')
...
from dotenv import load_dotenv
from pathlib import Path
load_dotenv(dotenv_path=Path(file).resolve().parent.parent / 'secrets.env')
